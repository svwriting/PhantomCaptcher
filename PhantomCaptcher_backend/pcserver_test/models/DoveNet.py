...
class DoveUnetGenerator(nn.Module):
    """Create a Unet-based generator"""

    def __init__(self, input_nc=4, output_nc=3, num_downs=8, ngf=64, use_dropout=True, use_attention=True):
        ...
        """
        super(DoveUnetGenerator, self).__init__()
